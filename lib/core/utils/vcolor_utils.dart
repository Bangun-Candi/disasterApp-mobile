...
class VColorUtils {
  static const Color backgroundColors = Color(0xFFFFFFFF);
  static const Color primaryColors = Color(0xFFFE724C);
  static const Color secondaryColors = Color(0xFFDF1995);

  static const Color textWhiteColors = Color(0xFFFEFEFE);
